(function() {
  ...
  function getcwQueryService($rootScope, $q, $uibModal, $timeout, $http, mnPendingQueryKeeper, validateCbasService, $httpParamSerializer,cwConstantsService,qwQueryPlanService,mnPoolDefault,mnPools,mnAuthService,mnServersService) {
    ...
    cwQueryService.getPastQueries = function() {return(pastQueries);}
    cwQueryService.getQueryHistoryLength = function() {return(pastQueries.length);}
...
//    });
    ...
    function getProblemFields(fields) {
      ...
      for (var f in fields) {
        ...
        var bucket = _.find(cwQueryService.buckets,function (b) {return(b.id == bucketName);});
        if (bucket) {
