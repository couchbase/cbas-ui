(function () {
  ...
  cbasController.$inject = ['$rootScope', '$stateParams', '$uibModal', '$uibModalStack', '$timeout', 'cwQueryService', 'validateCbasService',
    'mnPools', '$scope', 'cwConstantsService', 'mnPoolDefault', 'mnServersService', '$interval',
    'qwJsonCsvService'];

  function cbasController($rootScope, $stateParams, $uibModal, $uibModalStack, $timeout, cwQueryService, validateCbasService, mnPools, $scope, cwConstantsService, mnPoolDefault, mnServersService, $interval, qwJsonCsvService) {
    var qc = this;
