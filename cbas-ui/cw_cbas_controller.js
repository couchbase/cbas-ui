...
function createNewCollection() {
  ...
  createNewCollectionDialogScope.options = {
    ...
    is_new: true,
    databases: qc.databases.map(database => database.DatabaseName),
    dataverses: databaseNamesToScopeNames(qc.databases[0]?.DatabaseName || ""),
  ...
  createNewCollectionDialogScope.$watch(
    ...
    (newDatabaseName) => {
      createNewCollectionDialogScope.options.dataverses = databaseNamesToScopeNames(newDatabaseName);
